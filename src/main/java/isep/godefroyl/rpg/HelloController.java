...
public class HelloController {
    ...
    private void fightTurn(int i){
        ...
        if (fighterClass.equals( "isep.godefroyl.rpg.BasicEnemy")){
            ...
            nextTurn(i);
        } else if (fighterClass.equals("isep.godefroyl.rpg.Warrior")){
        ...
        } else if (fighterClass.equals("isep.godefroyl.rpg.Hunter")){
        ...
        } else if (fighterClass.equals("isep.godefroyl.rpg.Mage")){
        ...
        } else if (fighterClass.equals("isep.godefroyl.rpg.Healer")){
    ...
    private void postBattleTurn(int i){
        ...
        if (fighterClass.equals( "isep.godefroyl.rpg.Hunter") || fighterClass.equals("isep.godefroyl.rpg.Mage") || fighterClass.equals("isep.godefroyl.rpg.Healer")) {
